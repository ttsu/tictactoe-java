...
//    assertThat(availableState.getLastMove()).isEqualTo(new Block(2, 2));
//  }
//
//  @Test
...
//    assertThat(game.getLastMove()).isEqualTo(new Block(0, 0));
//  }
//
//  @Test
...
//    assertThat(game.getLastMove()).isEqualTo(new Block(0, 1));
//  }
//
//  // -- switchPlayer
//
